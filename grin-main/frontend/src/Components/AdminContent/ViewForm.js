    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const gsnData = Array.isArray(gsnResponse.data)
                    ? gsnResponse.data
                    : (gsnResponse.data?.data && Array.isArray(gsnResponse.data.data)
                        ? gsnResponse.data.data
                        : []);

                const grnData = Array.isArray(grnResponse.data)
                    ? grnResponse.data
                    : (grnResponse.data?.data && Array.isArray(grnResponse.data.data)
                        ? grnResponse.data.data
                        : []);
